// src/modules/taxgrouptaxtypemapper/taxgrouptaxtypemapper.schemas.js
...
const createSchema = Joi.object({
  ...
  ...joinedEchoes(QUERIES.TAX_GROUP_TAX_TYPE_MAPPER),
  TaxGroupId: entityId.required(),
  TaxTypeId: entityId.required(),
...
const updateSchema = Joi.object({
  ...
  // also a genuine input.
  ...joinedEchoes(QUERIES.TAX_GROUP_TAX_TYPE_MAPPER),
  TaxGroupId: entityId.optional(),
  TaxTypeId: entityId.optional(),
