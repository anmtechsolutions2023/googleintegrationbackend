// src/modules/taxgrouptaxtypemapper/taxgrouptaxtypemapper.controller.js
const service = require('./taxgrouptaxtypemapper.service');
...
const {
  ...
  paginationSchema,
  uuidParamSchema,
} = require('./taxgrouptaxtypemapper.schemas');
...
const getAll = asyncHandler(async (req, res) => {
  ...
  paginatedResponse(
    ...
    result.data,
    result.pagination,
    'Tax group tax type mappers retrieved successfully'
  );
});
...
const getById = asyncHandler(async (req, res) => {
  ...
  successResponse(
    res,
    data,
    'Tax group tax type mapper retrieved successfully'
  );
});
...
const create = asyncHandler(async (req, res) => {
  ...
  createdResponse(
    res,
    newData,
    'Tax group tax type mapper created successfully'
  );
});
...
const update = asyncHandler(async (req, res) => {
  ...
  successResponse(
    res,
    updated,
    'Tax group tax type mapper updated successfully'
  );
});

const deleteById = asyncHandler(async (req, res) => {
  await service.delete(req.params.id, req.user.tid);
  noContentResponse(res, 'Tax group tax type mapper deleted successfully');
});
