...
router.get('/', authenticateToken, auditLogCrud('Location Detail'), ...controller.getAll);
router.get('/:id', authenticateToken, auditLogCrud('Location Detail'), ...controller.getById);
router.post(
  '/',
  authenticateToken,
