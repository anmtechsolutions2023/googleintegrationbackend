// src/modules/branchusergroupmapper/branchusergroupmapper.controller.js
const service = require('./branchusergroupmapper.service');
...
const {
  ...
  uuidParamSchema,
  getByIdQuerySchema,
} = require('./branchusergroupmapper.schemas');
...
const getAll = asyncHandler(async (req, res) => {
  ...
  paginatedResponse(
    ...
    result.data,
    result.pagination,
    'Branch user group mappers retrieved successfully'
  );
});
...
const getById = asyncHandler(async (req, res) => {
  ...
  successResponse(res, data, 'Branch user group mapper retrieved successfully');
});
...
const create = asyncHandler(async (req, res) => {
  ...
  createdResponse(
    res,
    newData,
    'Branch user group mapper created successfully'
  );
});
...
const update = asyncHandler(async (req, res) => {
  ...
  successResponse(
    res,
    updated,
    'Branch user group mapper updated successfully'
  );
});

const deleteById = asyncHandler(async (req, res) => {
  await service.delete(req.params.id, req.user.tid);
  noContentResponse(res, 'Branch user group mapper deleted successfully');
});
