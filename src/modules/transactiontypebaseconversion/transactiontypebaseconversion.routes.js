...
router.get('/', authenticateToken, auditLogCrud('Transaction Type Base Conversion'), ...controller.getAll);
router.get('/:id', authenticateToken, auditLogCrud('Transaction Type Base Conversion'), ...controller.getById);
router.post(
  '/',
  authenticateToken,
