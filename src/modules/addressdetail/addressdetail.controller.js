// src/modules/addressdetail/addressdetail.controller.js
const service = require('./addressdetail.service');
...
const getById = asyncHandler(async (req, res) => {
  ...
  successResponse(res, data, 'Address detail retrieved successfully');
});

const create = asyncHandler(async (req, res) => {
  const newData = await service.create(req.body, req.user.tid, req.user.email);
  createdResponse(res, newData, 'Address detail created successfully');
});
...
const update = asyncHandler(async (req, res) => {
  ...
  successResponse(res, updated, 'Address detail updated successfully');
});

const deleteById = asyncHandler(async (req, res) => {
  await service.delete(req.params.id, req.user.tid);
  noContentResponse(res, 'Address detail deleted successfully');
});
