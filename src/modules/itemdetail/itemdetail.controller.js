// src/modules/itemdetail/itemdetail.controller.js
const service = require('./itemdetail.service');
...
const getById = asyncHandler(async (req, res) => {
  ...
  successResponse(res, data, 'Item detail retrieved successfully');
});

const create = asyncHandler(async (req, res) => {
  const newData = await service.create(req.body, req.user.tid, req.user.email);
  createdResponse(res, newData, 'Item detail created successfully');
});
...
const update = asyncHandler(async (req, res) => {
  ...
  successResponse(res, updated, 'Item detail updated successfully');
});

const deleteById = asyncHandler(async (req, res) => {
  await service.delete(req.params.id, req.user.tid);
  noContentResponse(res, 'Item detail deleted successfully');
});
