// src/modules/branchdetail/branchdetail.controller.js
const service = require('./branchdetail.service');
...
const getById = asyncHandler(async (req, res) => {
  ...
  successResponse(res, data, 'Branch detail retrieved successfully');
});

const create = asyncHandler(async (req, res) => {
  const newData = await service.create(req.body, req.user.tid, req.user.email);
  createdResponse(res, newData, 'Branch detail created successfully');
});
...
const update = asyncHandler(async (req, res) => {
  ...
  successResponse(res, updated, 'Branch detail updated successfully');
});

const deleteById = asyncHandler(async (req, res) => {
  await service.delete(req.params.id, req.user.tid);
  noContentResponse(res, 'Branch detail deleted successfully');
});
