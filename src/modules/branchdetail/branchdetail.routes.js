...
router.get('/', authenticateToken, auditLogCrud('Branch Detail'), ...controller.getAll);
router.get('/:id', authenticateToken, auditLogCrud('Branch Detail'), ...controller.getById);
