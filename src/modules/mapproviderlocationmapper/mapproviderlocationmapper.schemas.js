...
const createSchema = Joi.object({
  ...
  ...joinedEchoes(QUERIES.MAP_PROVIDER_LOCATION_MAPPER),
  MapProviderId: entityId.required(),
  LocationDetailId: entityId.required(),
...
const updateSchema = Joi.object({
  ...
  // also a genuine input.
  ...joinedEchoes(QUERIES.MAP_PROVIDER_LOCATION_MAPPER),
  MapProviderId: entityId.optional(),
  LocationDetailId: entityId.optional(),
