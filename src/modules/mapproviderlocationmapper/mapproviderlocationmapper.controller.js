// src/modules/mapproviderlocationmapper/mapproviderlocationmapper.controller.js
const service = require('./mapproviderlocationmapper.service');
...
const getAll = asyncHandler(async (req, res) => {
  ...
  paginatedResponse(
    ...
    result.data,
    result.pagination,
    'Map provider location mappers retrieved successfully'
  );
});
...
const getById = asyncHandler(async (req, res) => {
  ...
  successResponse(
    res,
    data,
    'Map provider location mapper retrieved successfully'
  );
});
...
const create = asyncHandler(async (req, res) => {
  ...
  createdResponse(
    res,
    newData,
    'Map provider location mapper created successfully'
  );
});
...
const update = asyncHandler(async (req, res) => {
  ...
  successResponse(
    res,
    updated,
    'Map provider location mapper updated successfully'
  );
});

const deleteById = asyncHandler(async (req, res) => {
  await service.delete(req.params.id, req.user.tid);
  noContentResponse(res, 'Map provider location mapper deleted successfully');
});
