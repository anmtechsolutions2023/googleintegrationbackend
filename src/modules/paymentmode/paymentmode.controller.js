// src/modules/paymentmode/paymentmode.controller.js
const service = require('./paymentmode.service');
...
const getById = asyncHandler(async (req, res) => {
  ...
  successResponse(res, data, 'Payment mode retrieved successfully');
});

const create = asyncHandler(async (req, res) => {
  const newData = await service.create(req.body, req.user.tid, req.user.email);
  createdResponse(res, newData, 'Payment mode created successfully');
});
...
const update = asyncHandler(async (req, res) => {
  ...
  successResponse(res, updated, 'Payment mode updated successfully');
});

const deleteById = asyncHandler(async (req, res) => {
  await service.delete(req.params.id, req.user.tid);
  noContentResponse(res, 'Payment mode deleted successfully');
});
