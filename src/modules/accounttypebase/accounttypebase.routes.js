...
router.get('/', authenticateToken, auditLogCrud('Account Type Base'), ...controller.getAll);
router.get('/:id', authenticateToken, auditLogCrud('Account Type Base'), ...controller.getById);
router.post(
  '/',
  authenticateToken,
