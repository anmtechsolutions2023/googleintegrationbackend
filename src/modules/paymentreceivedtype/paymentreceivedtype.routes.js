...
router.get('/', authenticateToken, auditLogCrud('Payment Received Type'), ...controller.getAll);
router.get('/:id', authenticateToken, auditLogCrud('Payment Received Type'), ...controller.getById);
router.post(
  '/',
  authenticateToken,
